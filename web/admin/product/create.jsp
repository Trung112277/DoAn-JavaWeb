                            ...
                            <div class="card-body">
                                <form action="CreateProductServlet" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="image" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter image">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="categoryId" class="form-control" id="exampleInputPassword1" placeholder="CategoryId">
                                    </div>
